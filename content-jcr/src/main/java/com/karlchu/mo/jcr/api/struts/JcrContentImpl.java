package com.karlchu.mo.jcr.api.struts;

import com.karlchu.mo.jcr.api.*;
...
public class JcrContentImpl implements IJcrContent {
     ...
     * @return
     */
    public String writeOrUpdate(final String path, final FileItem fileItem)  throws JcrException{
        Session session = JcrPlugin.getSession();
    ...
    @Override
    public List<FileItem> listStaticFiles(String path) {
        Session session = JcrPlugin.getSession();
